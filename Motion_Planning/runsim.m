...
fprintf('SFC -> Trajectory time is: %.4f sec', SFCTimes.total)


% Trajectory planning (star-convex)
wayPoints = path{path_id};
[X, SCMTimes] = StarConvexTrajectoryPlanning(wayPoints, obps, map.boundary, time_allocation);
fprintf('JPS -> StarConvexMethod time is : %.4f sec', SCMTimes.total);
